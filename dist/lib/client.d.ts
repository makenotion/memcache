...
export type CasCommandOptions = CommonCommandOption & StoreCommandOptions & Readonly<{
...
export type MultiMetaRetrievalResponse<ValueType = unknown> = Record<string, MetaRetrievalCommandResponse<ValueType>>;
...
type MultiMetaRetrieval<ValueType> = ValueType extends MultiMetaRetrievalResponse ? ValueType : MetaRetrievalCommandResponse<ValueType>;
export declare class MemcacheClient extends EventEmitter {
    ...
    shutdown(): void;
    send<ValueType>(data: StoreParams | SocketCallback, key: string, options?: CommonCommandOption, callback?: ErrorFirstCallback): Promise<ValueType>;
    xsend<ValueType>(data: StoreParams | SocketCallback, key: string, options?: StoreCommandOptions): Promise<ValueType>;
    cmd<Response>(data: string, key?: string, options?: CommonCommandOption, callback?: ErrorFirstCallback): Promise<Response>;
    set(key: string, value: StoreParams, options?: StoreCommandOptions, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    add(key: string, value: StoreParams, options?: StoreCommandOptions, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    replace(key: string, value: StoreParams, options?: StoreCommandOptions, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    append(key: string, value: StoreParams, options?: StoreCommandOptions, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    prepend(key: string, value: StoreParams, options?: StoreCommandOptions, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    cas(key: string, value: StoreParams, options: CasCommandOptions, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    delete(key: string, options?: CommonCommandOption, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    incr(key: string, value: number, options?: StoreCommandOptions, callback?: OperationCallback<Error, string>): Promise<string>;
    decr(key: string, value: number, options?: StoreCommandOptions, callback?: OperationCallback<Error, string>): Promise<string>;
    touch(key: string, exptime: string | number, options?: CommonCommandOption, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    version(callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    flush(exptime?: number, options?: CommonCommandOption, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    ...
    store(cmd: StoreCommands, key: string, value: StoreParams, options?: Partial<CasCommandOptions>, callback?: OperationCallback<Error, string[]>): Promise<string[]>;
    get<ValueType>(key: string | string[], options?: StoreCommandOptions, callback?: OperationCallback<Error, MultiRetrieval<ValueType>>): Promise<MultiRetrieval<ValueType>>;
    ...
    gets<ValueType>(key: string | string[], options?: StoreCommandOptions, callback?: OperationCallback<Error, MultiCasRetrieval<ValueType>>): Promise<MultiCasRetrieval<ValueType>>;
    ...
    retrieve<T>(cmd: RetrieveCommands, key: string[] | string, options?: StoreCommandOptions, callback?: ErrorFirstCallback, metaFlags?: string): Promise<T>;
    xretrieve(cmd: RetrieveCommands, key: string | string[], options?: StoreCommandOptions, metaFlags?: string): Promise<unknown>;
    _xretrieverByServer(cmd: RetrieveCommands, key: string | string[], options?: StoreCommandOptions, metaFlags?: string): Promise<unknown>;
    xretrieveWithErrors<Keys extends string>(cmd: RetrieveCommands, keys: Keys[], options?: StoreCommandOptions): Promise<MultiCasRetrievalWithErrorsResponse<unknown, Keys>>;
    _send(conn: MemcacheConnection, data: StoreParams | SocketCallback, options: Partial<CasCommandOptions>): Promise<unknown>;
    _callbackSend<ValueType>(data: StoreParams | SocketCallback, key: string, options?: Partial<CasCommandOptions>, callback?: ErrorFirstCallback): Promise<ValueType>;
